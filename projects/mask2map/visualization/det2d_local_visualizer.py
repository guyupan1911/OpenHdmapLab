...
class DetLocalVisualizer(Visualizer):
    ...
    Examples:
        ...
        >>> from xdlt.dl.lidar.structures import DetDataSample
        >>> from .visualization import DetLocalVisualizer
    ...
    def _draw_instances(self, image: np.ndarray, instances: InstanceList,
