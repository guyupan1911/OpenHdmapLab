...
class TemporalSelfAttention(nn.Module):
    ...
    def init_weights(self):
        ...
        # (8, 2) -> (8, num_levels * num_bev_queue, num_points, 2)
    ...
    def forward(self,
        ...
        # (bs, num_value, embed_dims) -> (bs * 2, num_value, num_heads, head_dims))
        ...
        attention_weights = attention_weights.permute(0, 3, 1, 2, 4, 5)\
            .reshape(bs*self.num_bev_queue, num_query, self.num_heads, self.num_levels, self.num_points).contigous()
